...
public class BasicDoubleLinkedListTestStudent {
	...
	public Car a=new Car("Toyota", "Corolla", 2020);
	public Car b=new Car("Ford", "Fiesta", 2019);
	public Car c=new Car("Honda", "Civic", 2021);
	public Car d=new Car("Nissan", "Sentra", 2020);
	public Car e=new Car("Chevrolet", "Impala", 2018);
	...
	public void setUp() throws Exception {
		...
		linkedDouble.addToEnd(12.5);
		linkedDouble.addToEnd(75.2);
